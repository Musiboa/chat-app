<template>
  <div class="search-input-container">
    <el-input v-model="keywords" placeholder="搜索" prefix-icon="Search"></el-input>
    ...
    <add-friends v-model="showAddFriends" class="add-friends-dialog"></add-friends>
    <create-chat-group v-model="showCreateChatGroup" class="create-chat-group-dialog"></create-chat-group>
  </div>
</template>
<script setup>
import { ref } from 'vue'
